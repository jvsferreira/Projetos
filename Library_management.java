...
public class Library_management extends JFrame implements ActionListener, java.awt.event.ActionListener {
    /**
	 * 
	 */
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addButton) {
            ...
            String[] columns = {"ID do Livro", "Título do Livro", "Autor", "Editora", "Ano de Publicação", "ISBN", "Número de Cópias"};
...
String bookID = JOptionPane.showInputDialog(this, "Entre com o ID do livro para editar:");
for (int i = 0; i < books.size(); i++) {
...
String bookID = JOptionPane.showInputDialog(this, "Entre com o ID do livro que deseja deletar:");
for (int i = 0; i < books.size(); i++) {
if (books.get(i)[0].equals(bookID)) {
books.remove(i);
