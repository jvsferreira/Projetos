...
public class Tic_tac_toe implements ActionListener, java.awt.event.ActionListener {
    ...
    public void checkForWinner() {
        ...
        for (int i = 0; i < 9; i += 3) {
            if (buttons[i].getText().equals(buttons[i+1].getText()) && buttons[i].getText().equals(buttons[i+2].getText()) && !buttons[i].isEnabled()) {
                JOptionPane.showMessageDialog(frame, buttons[i].getText() + " venceu!");
                resetGame();
                return;
            }
        }
        ...
        if (buttons[0].getText().equals(buttons[4].getText()) && buttons[0].getText().equals(buttons[8].getText()) && !buttons[0].isEnabled()) {
            JOptionPane.showMessageDialog(frame, buttons[0].getText() + " venceu!");
            resetGame();
            return;
        }
        if (buttons[2].getText().equals(buttons[4].getText()) && buttons[2].getText().equals(buttons[6].getText()) && !buttons[2].isEnabled()) {
            JOptionPane.showMessageDialog(frame, buttons[2].getText() + " venceu!");
            resetGame();
            return;
        }
        ...
        if (tie) {
            JOptionPane.showMessageDialog(frame, "Jogo da Velha!");
            resetGame();
        }
    }
